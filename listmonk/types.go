...
type Transactional struct {
	...
	Data            map[string]interface{}   `url:"data,omitempty"`          //	Map	Optional	Optional data in {} nested map. Available in the template as {{ .Tx.Data.* }}
	Headers         []map[string]interface{} `url:"headers,omitempty"`       //	[]Map	Optional	Optional array of mail headers. [{"key": "value"}, {"key": "value"}]
